        ...
        if (findUser != null) {
            ...
            if (remember != null && remember.equals(Boolean.TRUE)) {
                String cookieValue = Base64.encode(findUser.getUsername())
                        .concat(Monster.Session.COOKIE_SPLIT).concat(findUser.getPassword());
                CookieUtils.setCookie(data.getResponse(), Monster.Session.REMEMBER_COOKIE_NAME,
            ...
            String redirectUrl =
                    findUser.getDefaultRoleId() == masterRoleId
                            ? Monster.Session.MANAGEMENT_INDEX
                            : Monster.Session.FRONTEND_INDEX;
