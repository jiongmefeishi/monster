...
import cn.zqtao.monster.exception.UnauthorizedRoleException;
import cn.zqtao.monster.exception.UserNotLoginException;
...
public class NBAuthAspect extends BaseController {
     ...
     * 权限验证切点
     */
    @Pointcut("@annotation(cn.zqtao.monster.config.permission.NBAuth)")
     ...
     * 角色验证切点
     */
    @Pointcut("@annotation(cn.zqtao.monster.config.permission.NBAuthRole)")
